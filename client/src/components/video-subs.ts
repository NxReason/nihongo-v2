...
export class VideoSubs extends LitElement {
    ...
    constructor() {
        ...
        this.addEventListener('subs-uploads-picked', () => { this.tab = 'uploads'; })
        this.addEventListener('subs-settings-picked', () => { this.tab = 'settings'; })
        this.addEventListener('subs-layout-picked', () => { this.tab = 'layout'; })
    ...
    public setCurrentTime(ts: number) {
        const currentSub = this.bSearchSub(ts);
